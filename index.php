...
<html lang="en-US">
    ...
    <body data-spy="scroll" data-target="#main-navbar">
    	...
    	<div class="body">
                ...
                <nav id="main-navbar" class="navbar navbar-default navbar-fixed-top" role="navigation"> <!-- Classes: navbar-default, navbar-inverse, navbar-fixed-top, navbar-fixed-bottom, navbar-transparent. Note: If you use non-transparent navbar, set "height: 98px;" to #header -->
                  ...
                  <div class="container">
                    ...
                    <div class="navbar-header">
                      ...
                      <a class="navbar-brand page-scroll" href="index.html">QUALSERV</a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a class="page-scroll" href="#about-section">Links</a></li>
                            <li><a class="page-scroll" href="#services-section">QSU</a></li>
                            <li><a class="page-scroll" href="#contact-section">Place a Ticket</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                  </div><!-- /.container -->
                </nav>
			...
			<section id="text-carousel-intro-section" class="parallax" data-stellar-background-ratio="0.5" style="background-image: url(img/kitchen.jfif);">
			</section>
			...
			<section id="about-section" class="page bg-style1">
                ...
                <div class="page-header-wrapper">
                    <div class="container">
                        <div class="page-header text-center wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <p class="subtitle">Important Links</p>
                        </div>
                    </div>
                </div>
                <!-- End page header-->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <a href="https://www.qualservcorp.com/" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="https://store.abidentity.com/collections/qualserv" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.2s">
                                    <span class="rotate-box-icon"><i class="fa fa-users"></i></span>
                                    <div class="rotate-box-info">
                                        <h4></h4>
                                        <h4>Shop QualServ</h4>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="https://mail.qualservcorp.com/owa/auth/logon.aspx?replaceCurrent=1&url=https%3a%2f%2fmail.qualservcorp.com%2fowa" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.4s">
                                    <span class="rotate-box-icon"><i class="fa fa-users"></i></span>
                                    <div class="rotate-box-info">
                                        <h4></h4>
                                        <h4>QualServ Web Mail</h4>
                                    </div>
                                </a>
                            </div>
                            
                            <div class="col-md-3 col-sm-6">
                                <a href="../img/Phone_List.pdf" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.6s">
                                    <span class="rotate-box-icon"><i class="fa fa-users"></i></span>
                                    <div class="rotate-box-info">
                                        <h4></h4>
                                        <h4>QS Telephone Directory</h4>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="rotate-box-1-wrapper">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <a href="https://www.ups.com/us/en/global.page" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0">
                                    <span class="rotate-box-icon"><i class="fa fa-users"></i></span>
                                    <div class="rotate-box-info">
                                        <h4></h4>
                                        <h4>UPS</h4>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="https://www.fedex.com/global/choose-location.html" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.2s">
                                    <span class="rotate-box-icon"><i class="fa fa-users"></i></span>
                                    <div class="rotate-box-info">
                                        <h4></h4>
                                        <h4>FedEx</h4>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="https://www.google.com/" class="rotate-box-1 square-icon wow zoomIn" data-wow-delay="0.4s">
                                    <span class="rotate-box-icon"><i class="fa fa-users"></i></span>
                                    <div class="rotate-box-info">
                                        <h4></h4>
                                        <h4>Google</h4>
                        	...
                        	<div class="col-sm-6">
                                <div class="contact-form">
                                    ...
                                    <form role="form">
                                        ...
                                        <button type="submit" name="ticket" class="btn wow bounceInRight" data-wow-delay="0.8s">Send</button>
                                    </form>
                                </div>	
                            </div>
